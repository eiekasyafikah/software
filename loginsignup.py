...
window.title('Run Code')

# Window Icon Photo
try:
    icon = PhotoImage(file="C:/Users/User/Documents/VsCode/tkinter/picture.png")
...
# ===== Email icon =========
email_icon = Image.open("C:/Users/User/Documents/VsCode/tkinter/email (2).png")
photo = ImageTk.PhotoImage(email_icon)
emailIcon_label = Label(design_frame4, image=photo, bg='#f8f8f8')
emailIcon_label.image = photo
emailIcon_label.place(x=57, y=152)

# ===== password icon =========
password_icon = Image.open("C:/Users/User/Documents/VsCode/tkinter/password (2).png")
photo = ImageTk.PhotoImage(password_icon)
password_icon_label = Label(design_frame4, image=photo, bg='#f8f8f8')
password_icon_label.image = photo
password_icon_label.place(x=57, y=239)

# ===== picture icon =========
picture_icon = Image.open("C:/Users/User/Documents/VsCode/tkinter/male.png")
...
picture_icon_label.place(x=50, y=5,)

# ===== Left Side Picture ============
side_image = Image.open("C:/Users/User/Documents/VsCode/tkinter/vector.jpg")
...
# Define the forgot_password function before it is called
def forgot_password():
    win = tk.Toplevel()
    # ... (rest of your forgot_password code)
...
password_icon_label.image = photo
password_icon_label.place(x=200, y=280)

# ===== confirm password icon =========
confirmPassword_icon = Image.open("C:/Users/User/Documents/VsCode/tkinter/password (2).png")
...
confirmPassword_icon_label.place(x=200, y=370)
...
emailIcon_label.image = photo
emailIcon_label.place(x=200, y=205)

# ===== Full Name icon =========
name_icon = Image.open("C:/Users/User/Documents/VsCode/tkinter/person (2).png")
photo = ImageTk.PhotoImage(name_icon)
nameIcon_label = Label(design_frame8, image=photo, bg='#f8f8f8')
nameIcon_label.image = photo
nameIcon_label.place(x=200, y=128)
...
side_image_label.image = photo
side_image_label.place(x=30, y=10)
